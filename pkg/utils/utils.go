...
// GetErrorCodes Kepler'dan gelen hata kodlarını döndürür
// Hem ders ekleme (ECRN) hem ders silme (SCRN) işlemleri için kullanılır
func GetErrorCodes() map[string]string {
	return map[string]string{
		...
		"dropSuccessResult": "The course with CRN %s has been successfully dropped.",

		// Genel hata mesajları
		"errorResult": "No operation was completed in this process group.",
		"error":       "An error occurred during the operation.",

		// Ders ekleme hata kodları
		...
		// Ders silme (drop) için ek hata kodları
		"VAL21": "The course with CRN %s cannot be dropped during this period.",
		"VAL22": "The course with CRN %s is not in your current schedule.",
		...
		"NULLParam-CheckOgrenciKayitZamaniKontrolu": "The course with CRN %s cannot be processed due to 'Enrollment Time Hold'.",
	}
}
